...
public class ScoringSingletonIntegrationTest {
	...
	//to test if the member does not have variables of interest
	//in this case, the member does not have variables 4 and 10 which are associated with model 35
	//but these variables, because of rts scoring are unexpired in changedMemScore and hence used for the current scoring
	@Test
	...
	//to test if a member does not have record in memberVariables collection, then the member should not be scored
	@Test
