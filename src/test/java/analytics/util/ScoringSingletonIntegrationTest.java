...
public class ScoringSingletonIntegrationTest {
	...
	public static void initializeFakeMongo() throws InstantiationException,
		...
		varColl.insert(new BasicDBObject("name", "Boost_Browse_variable7").append("VID", 7).append("strategy","StrategyBoostProductTotalCount"));
		...
		dbList.add(new BasicDBObject("name", "Boost_Browse_variable7").append("coefficient", 0.1));
