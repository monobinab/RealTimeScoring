...
public class OutboxDao extends AbstractMySQLDao{
	...
	public List<EmailPackage> queueEmailPackages(List<EmailPackage> emailPackages, String format) throws SQLException {
		...
		try{
			...
			LOGGER.error("Exception Occured in queueEmailPackages " + e.getMessage());
		}finally{
			if(statement!=null)
				statement.close();
		}
	...
	public Date getSentDate(String lyl_id_no, String occasionName) throws SQLException {
		...
		try{ 
			...
			LOGGER.error("Exception Occured in getSentDate " + e.getMessage());
		}finally{
			if(statement!=null)
				statement.close();
		}
	...
	public EmailPackage getInProgressPackage(String lyl_id_no, List<OccasionInfo> occasionsInfo, String format) throws SQLException, ParseException {
		...
		try{
			...
			LOGGER.error("Exception Occured in getInProgressPackage " + e.getMessage());
		}finally{
			if(statement!=null)
				statement.close();
		}
