...
public class AAM_BrowseTopology {
	...
	public static void main(String[] args) throws Exception {
		...
		topologyBuilder.setBolt("browseCountPersist", new BrowseCountPersistBolt(System.getProperty(MongoNameConstants.IS_PROD)), 3).shuffleGrouping("parsingBoltBrowse", "browse_tag_stream");
