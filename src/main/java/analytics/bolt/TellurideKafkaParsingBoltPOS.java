...
public class TellurideKafkaParsingBoltPOS extends TellurideParsingBoltPOS {
	...
	public void logPersist(String memberNumber, String pickUpStoreNumber,
			...
			String transactionTime, String division, String itemNumber, String value, String earnFlag, String queueType) {
		
		super.logPersist(memberNumber, pickUpStoreNumber, tenderStoreNumber,
				orderStoreNumber, registerNumber, transactionNumber, requestorId, transactionTime, division, itemNumber, value, earnFlag, "kafka");
	}
