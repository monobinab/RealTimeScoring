...
public class WebsphereMQSpout_Old extends BaseRichSpout {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(WebsphereMQSpout_Old.class);
	 ...
	 *           - queue name
	 */
	public WebsphereMQSpout_Old(final String hostName, final int port, final String queueManager, final String queueChannel,
